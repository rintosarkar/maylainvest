...
<?php
	...
	if(isset($_POST['employerName'])) {
		if($_POST['employerName']	=="" || $_POST['employersAddress'] =="" || $_POST['postalCode3']	=="" || $_POST['occupation'] ==""  || $_POST['department'] ==""  || $_POST['monthlyIncome'] ==""  || $_POST['propertyType'] ==""  || $_POST['situatedProperty'] ==""  || $_POST['valueOfProperty'] ==""){
...
<head>
	...
	<script src="js/familyinfovalidation.js"></script>
			...
			<!-- This div place for Forms Only -->
					...
					===================================================================
					 ...
					 <div class="mainFormHeader">
					 		<div class="formTitle">
					 			<p class="family-info-header-text">Family Details Informations</p>
					 		</div>
						 	<div class="subFormHeader">
						 		<p class="family-info-header-text">Marital Status</p>
						 	</div>
						 	<!-- <div class="">
								 ...
								 <!--	<div class="spouseDetails">	
							 		...
							 		<div class="subFormHeader">
							 				 		<p class="">Spouse Details/Next of Kin Details</p>
							 				 		<p style="font-size:14px; color:#000;">(Not residing at the applicant's address)</p>
							 				 	</div>
									 	...
									 	<div class="submit-btn">
									 		...
									 		<div class="next-btn clear"><input type="submit" class="submit" value="Next" id="next2" name="next2" onclick="return formValidator()"/></div>
									 	</div>										
								 	</form><!-- </form> -->
